...
public class PostLoginActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActionBar.TabListener tabListener = new ActionBar.TabListener(){
			...
			//Add New Tab
			actionBar.addTab(actionBar.newTab().setText("Password").setTabListener(tabListener));
			actionBar.addTab(actionBar.newTab().setText("Reminder").setTabListener(tabListener));
